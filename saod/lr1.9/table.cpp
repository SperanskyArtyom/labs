...
int main()
{
    ...
    RenderWindow window(VideoMode(winSizeX, winSizeY), L"Трудоемкость пирамидальной сортировки");
    ...
    VertexArray lines(Lines, linesCount);
    ...
    // columns
    for (int i = 12, x = 10 + dx; i < linesCount; i += 2, x += dx)
    {
    ...
    text[1].setString(L"HeapSort (Mф + Cф)");
